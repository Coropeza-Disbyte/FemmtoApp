...
// Historial de mediciones de glucosa en sangre
class GlucoseHistoryPage extends BasePage {
  // Modal de confirmación de borrado
  get deleteModalTitle()    { return this.$contains('Estás seguro de que deseas eliminar'); }
  get deleteModalMessage()  { return this.$text('Recuerda que eliminar mediciones correctas puede afectar el seguimiento de tu glucosa en sangre.'); }
...
module.exports = GlucoseHistoryPage;
